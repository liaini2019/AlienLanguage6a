...
Sequence("Consent", "Welcome", "Start", "nonparty", "AlienIntro", "GroupingIntro", "Reminder1", "Grouping1", "Reminder2", "Grouping2", "GroupingFlower", "Reminder3", "Grouping3", "Reminder4", "Grouping4", "LearningIntro1", "LearningIntro2",
...
,
 newTextInput("answer")
    ...
    .log()
   // getTextInput("answer").testNot.text("")
       // .failure( newText("Please enter the numbers.").print())
,
